...
class AirCanvasProcessor(VideoProcessorBase):
    ...
    def recv(self, frame: av.VideoFrame) -> av.VideoFrame:
        ...
        if not self.mp_loaded:
            cv2.putText(img, "Error: Missing packages.txt", (50, 50), cv2.FONT_HERSHEY_SIMPLEX, 1, (0, 0, 255), 2)
            cv2.putText(img, "Please add libgl1-mesa-glx to packages.txt", (50, 100), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (0, 0, 255), 2)
...
# STUN/TURN Server Configuration to fix 'Camera not opening'
RTC_CONFIGURATION = {
